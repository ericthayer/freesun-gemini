              ...
              >
                ...
                {isPilot && (
                  <div className="absolute top-6 left-6">
                    <span className="bg-teal-600 text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="absolute inset-x-0 bottom-0 p-8 bg-gradient-to-t from-black/90 via-black/20 to-transparent group-hover:translate-y-full transition-transform duration-500">
                  <div className="text-white">
                    <h3 className={`font-bold ${isPilot ? 'text-3xl' : 'text-xl'}`}>{member.name}</h3>
                    <p className="text-xs font-bold uppercase tracking-widest">{member.role}</p>
                  </div>
                </div>
