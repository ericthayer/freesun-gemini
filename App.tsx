...
const AppContent: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme}`}>
      ...
      <header className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/90 border-b border-primary dark:border-primary/20">
